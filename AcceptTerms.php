...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['acceptTermsBox'])) {
        $_SESSION["acceptedTerms"] = 1;

        $custID = $_SESSION["customer_id"];
        $query = "UPDATE customers SET data_agreement = 1 WHERE customer_id=$custID";
        if (mysqli_query($link, $query)) {
            $sql = "UPDATE customers SET last_login=now(), term_date = now() WHERE customer_id=$custID";
                ...
                <div class="col-md-12">
                    <div class="card-body-register">
                        <div id="innerWrapper">
                            ...
                            <br>
                            <div class="inputDiv">
                                <div style="height:40vh;width:50vw;background-color: white;border:1px solid #ccc;font:16px/26px Georgia, Garamond, Serif;overflow:auto;">
                                ...
                                <form name="form" method="post">
                                    <?php
                                    if (!termsAccepted()) {
                                        echo '<div id="termsDiv">
                                            <input type="radio" name="acceptTermsBox" id="acceptTermsBox"><span id="acceptTermsInfo"> I have read and accept the terms.</span>
                                            </div>';
                                    }
                                    ?>
                                    <div id="termsDiv">
                                        <input type="radio" name="notAcceptTermsBox" id="notAcceptTermsBox"><span id="acceptTermsInfo"> I do not accept.</span>
